...
#         xlabel += '\n{}'.format(info)
#
#     # path = os.path.dirname(os.path.join(os.path.abspath(''), "NanumBarunGothic.ttf"))
#     # koreanfontprop = fm.FontProperties(fname=path)
#
#     plt.xlabel(xlabel)
#     plt.ylabel(ylabel)
#
...
#             else:
#                 break
#         # Added fontproperties
#         # if isKorean:
#         #     plt.title(text, fontproperties=koreanfontprop)
#         # else:
#         #     plt.title(text)
#
#     plt.tight_layout()
