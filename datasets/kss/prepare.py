...
def read_csv(path,fn_encoding='UTF8'):
    ...
    with open(path, encoding=fn_encoding) as f:
        ...
        for line in f:
            audio_name, audio_transcript,audio_normalized_transcript, deprecated_1, deprecated_2 = line.split('|')

            replace_audio_name = audio_name.replace("/", "\\")
            replace_audio_name = replace_audio_name.replace(".wav", "")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--metadata', default="transcript.v.1.2.txt")
